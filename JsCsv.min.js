...
!function(){function t(t){if(null==t)throw Error("csv cannot be null");if("string"!=typeof t)throw Error("This object is not supported")}function e(t,e,o){for(var s=t.split("\n"),i=0,a=0;a<s.length&&r(s[a],e,o.name);a++)i++;return n(s,i,e,o)}function r(t,e,r){return t.startsWith(i)||0==t.length||""+r==""+t.split(e)}function n(t,e,r,n){for(var s=[],i=e;i<t.length&&0!=t[i].length;i++)s.push(o(t[i],r,n));return s}function o(t,e,r){for(var n={},o=t.split(e),i=0;i<o.length;i++)n[r.name[i]]=s(o[i],r.datatype[i]);return n}function s(t,e){var r;switch(e){case"short":case"int":case"long":r=Number.parseInt(t);break;case"float":case"double":r=Number.parseFloat(t);break;default:r=t}return r}var i="#",a=function(r,n,o){t(r),this.store=e(r,n,o)};a.prototype.getStore=function(){return this.store},a.prototype.getGeoJSon=function(t){for(var e=t.RA,r=t.DEC,n=t.ID,o=[],s=0;s<this.store.length;s++){var i={type:"Feature",id:this.store[s][n],geometry:{type:"Point",coordinates:[this.store[s][e],this.store[s][r]]}},a=JSON.parse(JSON.stringify(this.store[s]));delete a[e],delete a[r],delete a[n],i.properties=a,o.push(i)}var u={type:"FeatureCollection",features:o};return u};var u={};return u.Csv=a,u.version={major:1,minor:0,patch:0,date:"2016-10-14",toString:function(){return this.major+"."+this.minor+"."+this.patch}},window.JsCsv=u,u}();